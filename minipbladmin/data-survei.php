                        ...
                        <center>
                            ...
                            <table width="625">
                                <td>
                                    ...
                                    <input type="text" name="nomor_surat" id="nomor_surat" placeholder="Nomor surat"><br>
                                    <label for="lamp">Lamp &nbsp;: </label>
                                    <input type="text" name="lamp" id="lamp"><br>
                                    <label for="hal">Hal &nbsp;&emsp; :</label>
                                    <input type="text" name="hal" id="hal" placeholder="Perihal"><br>
                                </td>
                            </table>
                            <br>
                            <table width="625">
                            ...
                            <table width="625">
                                ...
                                <tr>
                                    <td>
                                        <label for="perihal">Lokasi Dan Tanggal Kejadian &nbsp;<br><?php echo $format['perihal'] ?></label><br>
                                    </td>
                                </tr>
                            </table>
                            <br>
