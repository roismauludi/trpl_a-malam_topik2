...
<body>
    <form action="p-izin.php" method="POST">
        <?php
        include "config.php";
            ...
            <div class="container">
                <div class="col-md-10 col-md-offset-1">
                    ...
                    <table border="1" width="625">
                        ...
                        ?>
                            <tr>
                                <td align="center">Tanggal izin</td>
                                <td align="center">Mata Kuliah</td>
                                <td align="center">Nama Dosen</td>
                                <td align="center">Jumlah Sesi</td>
                            </tr>
                            <tr>
                                <td align="center"><?php echo $format['mulai'] ?> - <?php echo $format['sampai'] ?></td>
                    ...
                    <table width="625">
                        <td></td>
                        <td class="text2" align="left">Mengetahui<br><br><br><br><br><input type="text" name="nama_wali" id="nama_wali" placeholder="Orangtua / Wali"><br>Orang Tua / Wali</td>
                        <td width="430"></td>
                        <td class="text2" align="center">Hormat saya<br><br><br><br><br><input type="text" name="nama_mhs" id="nama_mhs" placeholder="Nama Mahasiswa"><br>Mahasiswa</td>
