                ...
                <tr>
                    <center>
                        ...
                        <table width="625">
                            <tr>
                                <td>
                                    <label for="kepada">Dengan Hormat,
                                        &nbsp;<br><?php echo $format['isi'] ?></label><br>
                                </td>
                            </tr>
                        </table>
                        <br>
                        <table width="625">
                            <tr>
                                <td>
                                    Informasi berupa data yang didapat akan digunakan sebagaimana mestinya, adapun
                                    nama<br>
                        ...
                        <table width="625">
                            <td width="430"></td>
                            <td class="text2" align="left">Ketua jurusan<br>Teknik
                                Informatika<br><br><br><br><br><u>Sudra Irawan, S.Pd.Si.,M.Se.</u><br>NIP :
                                198801082015041001</td>
                        </table>
                        </table>
                    </center>
                </tr>
