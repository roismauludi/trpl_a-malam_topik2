        ...
        <nav>
            <ul>
                ...
                <li><a href="index.php">
                        ...
                        <span class="nav-item">Halaman Utama</span>
                    </a></li>
                <li><a href="jenis-surat.php">
                        <i class="fas fa-mail-bulk"></i>
                        <span class="nav-item">Surat</span>
                    </a></li>
                <li><a href="login_mhs.php" onclick="return confirm('Apakah anda yakin ingin keluar ?')">
        ...
        <section class="main">
            ...
            <section>
                ...
                <div fxLayout="row">
                    ...
                    <div fxFlex="50">
                        <img src="assets/utama.jpg" alt="gambar" style="height: 35%; width: 35%; margin-left: 47.1rem; position: relative; top:-307px" />
                    </div>
                </div>
    </div>
</body>
